...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "F41A8"  # Playfab Title Id
        self.SecretKey: str = "PEO61DC46R664RMAEQBYT8SZ6RURE3UWXA6IRGPIB5IWXCNOHB"  # Playfab Secret Key
        self.ApiKey: str = "OC|1198089806721536|74c7ea2e116076c61edba57527378683"  # App Api Key (Oculus/Graph API)
...
def titledata():
    response_data = {
        ...
        "MOTD": "<color=#FFC0CB>WELCOME TO FAST TAG V2!</color>\n\n<color=#0099c2>CURRENT UPDATE: FALL24</color>\n<color=#cacfd2>OWNER : ZENON</color>\n<color=#41ff80>ZENON MADE THIS MOTD</color>\n<color=#6417ff>OUR DEVELOPERS ARE: ZENON</color>\n<color=#ac1a00>THIS IS A V2 OF AN OLD GAME!</color>\n\n<color=#91A3B0>TS TUFF</color>",
